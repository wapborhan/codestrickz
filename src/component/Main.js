...
export default class Main extends Component {
  state = {
    delayed: false,
    showLastRead: true,
    lastRead: window.localStorage.lastRead
      ? window.localStorage.lastRead.split("-")
      : null,
  };
  ...
  render() {
    ...
    const delayMsg = (
      <span>
        I have got a bad server... If your internet connection is not slow,
        please reload
      </span>
    );
